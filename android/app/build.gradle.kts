...
android {
    ...
    defaultConfig {
        ...
        // Include both 32-bit and 64-bit ARM so Redmi and other 32-bit devices can install from Play Store
        ndk {
            abiFilters.clear()
...
dependencies {
    ...
    // Firebase Functions requires FirebaseInstanceIdInternal (iid interop) on some versions.
    // This prevents release startup crashes: MissingDependencyException: FirebaseInstanceIdInternal
