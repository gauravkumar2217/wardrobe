...
/// Top-liked style looks from the user's friends/community.
...
class _TrendingStylesScreenState extends State<TrendingStylesScreen> {
  ...
  Future<void> _load() async {
    ...
    try {
      final posts = await StylePostService.getTrending();
      if (!mounted) return;
      setState(() {
        _posts = posts;
        _loading = false;
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        backgroundColor: WardrobeTokens.emeraldBg,
        title: const Text('Trending Styles'),
        centerTitle: true,
      ),
      body: _loading
                      ...
                      child: Padding(
                        ...
                        child: Column(
                          ...
                          children: [
                            ...
                            const Text(
                              'Add friends and share style posts — the most liked looks show up here.',
